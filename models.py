...
class User(db.Model):
    ...
    # isOfficiatingHod: Mapped[Optional[bool]] = mapped_column(nullable=True)
    isOfficiating: Mapped[Optional[bool]]
    ...
    def __init__(self, json):
        ...
        # self.isOfficiatingHod = False
        self.isOfficiating= False
    ...
    def json(self):
        return {
                ...
                "isOfficiating": self.isOfficiating
                }
...
class LTCInfo(db.Model):
    ...
    rejectedBy: Mapped[Optional[int]]
